...
class TrucksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create truck" do
    assert_difference('Truck.count') do
      post trucks_url, params: { truck: { day_off: @truck.day_off, day_start: @truck.day_start, driver_no: @truck.driver_no, truck_driver: @truck.truck_driver, truck_no: @truck.truck_no } }
    end
  ...
  test "should update truck" do
    patch truck_url(@truck), params: { truck: { day_off: @truck.day_off, day_start: @truck.day_start, driver_no: @truck.driver_no, truck_driver: @truck.truck_driver, truck_no: @truck.truck_no } }
